...
import { GLib, writeFile, Variable, exec, Gio, execAsync } from "astal";
...
export function monitorColorsChange() {
  const monitorList = [
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/colors.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/applauncher.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/Bar.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/common.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/components.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/quicksettings.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/main.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/notification.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/dashboard.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/notificationsWindow.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/osd.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/mediaPlayer.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/popupMenu.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/powermenu.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/roundedcorners.scss`,
    `${GLib.getenv("HOME")}/.config/ags-gtk4/style/wallpaperpicker.scss`,
  ];
  monitorList.forEach(file => {
    monitorFile(file, () => {
      const target = "/tmp/astal/style.css";
      exec(
        `sass ${GLib.getenv("HOME")}/.config/ags-gtk4/style/main.scss ${target}`,
      );
      App.reset_css();
